...
def build_synthesis_prompt(packet: dict[str, Any]) -> str:
    ...
    return (
        ...
        "terms, or generic advice. Keep it tight: summary under 400 characters, "
        "recommendation.conclusion 50-400 characters, recommendation.next_move 20-200 "
        "characters, each action instruction 20-220 characters, each completion check "
        "8-120 characters. Drop generic procedure the evidence does not force, and never "
        "restate the same fact in two fields.\n"
