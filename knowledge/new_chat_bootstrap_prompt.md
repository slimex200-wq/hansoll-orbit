...
```text
너는 OpenCrab Talbots 업무 프로젝트 기준으로 진행해.

프로젝트 root:
C:\Users\shjung1\Documents\Codex\2026-05-13\open-crab

주의:
C:\Users\shjung1\OpenCrab 은 Talbots용 프로젝트가 아니야.
Talbots/MGF 업무는 반드시 C:\Users\shjung1\Documents\Codex\2026-05-13\open-crab 기준으로 진행해.
...
산출물 완료 전에 다시 열어서 스타일 번호, 시트, 이미지, 양식 marker를 검증해.
```
